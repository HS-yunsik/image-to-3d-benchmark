...
\affiliation{국문 소속 (10pt)}

\authoremail{\{email1, email2, email3, email4\}@xxx.yy.zz.kr (9pt)}

%% English title.
\entitle{English Title (굵게, 14pt)}

%% English author names.
\enauthor{Author1$^{\circ}$
\and Author2
\and Author3
\and Author4$^{*}$ (12pt)}

\enaffiliation{English Affiliation (영문소속) (10pt)}
